...
const IndexPage: React.FC<PageQuery> = ({ data }) => {
  return (
    <Layout>
      <SEO title="Home" />
      <h1 className="text-4xl">Hi {data.site.siteMetadata.author}</h1>
      <p className="text-xl mt-3">Welcome to your new Gatsby site.</p>
      <p className="text-base mt-2">{data.site.siteMetadata.description}</p>
