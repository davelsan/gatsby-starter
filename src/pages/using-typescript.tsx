...
class UsingTypescript extends React.Component<PageProps & PageQuery> {
  onButtonClick: React.EventHandler<
    ...
    return (
      <Layout>
        ...
        <p className="sm:text-lg mt-3">
          ...
          files (like gatsby-node.js) currently don&apos;t support TypeScript
          yet.
        </p>
        ...
        <p className="sm:text-lg mt-2">
          You&apos;re currently on the page &quot;{this.props.path}&quot; which
          was built on {this.props.data.site.buildTime}.
        </p>
        <p className="sm:text-lg mt-2">
